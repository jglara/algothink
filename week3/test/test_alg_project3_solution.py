...
from alg_project3_solution import slow_closest_pair, fast_closest_pair,\
    closest_pair_strip, kmeans_clustering

class test_slow_closest_pair(unittest.TestCase):
    def test01(self):
...
class test_closest_pair_strip(unittest.TestCase):
    def test01(self):
...
class test_fast_closest_pair(unittest.TestCase):
    def test01(self):
